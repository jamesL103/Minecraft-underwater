...
public class SandstoneIronOre extends AbstractSandstoneOreBlock{

    public static final String ID = "sandstone_iron_ore";

    public SandstoneIronOre(Settings settings) {
        super(settings);
    }
